...
# ============ SEED DATA ============
SEED_VERSION = "2026-09-v7-official-pricing"

PRODUCTS = [{'slug': 'norton-antivirus-plus',
  'name': 'Norton AntiVirus Plus',
  'tagline': 'Essential virus and malware protection for 1 PC',
  'description': 'Real-time protection against viruses, malware, ransomware and hacking, with a smart '
                 'firewall, password manager and 2GB cloud backup.',
  'category': 'AntiVirus',
  'brand': 'Norton',
  'box_variant': 'gold',
  'image_url': '',
  'features': ['Real-time threat protection',
               'Smart Firewall',
               'Password Manager',
               '2GB Cloud Backup',
               '100% Virus Protection Promise'],
  'variants': [{'devices': 1, 'years': 1, 'label': '1 PC / 1 Year', 'price': 24.99, 'original_price': 29.99},
               {'devices': 1,
                'years': 2,
                'label': '1 PC / 2 Years',
                'price': 49.99,
 ...
 {'slug': 'norton-360-standard',
  ...
  'description': 'Real-time protection against viruses, ransomware and online threats. Includes Secure VPN, '
                 'Password Manager, Dark Web Monitoring and 10GB cloud backup.',
  'category': 'Norton 360',
  'brand': 'Norton',
  'box_variant': 'gold',
  'image_url': '',
 ...
 {'slug': 'norton-360-deluxe',
  ...
  'description': 'Multi-layered security with Secure VPN, Password Manager, Dark Web Monitoring, 50GB PC '
                 'cloud backup and parental controls.',
  'category': 'Norton 360',
  'brand': 'Norton',
  'box_variant': 'gold',
  'image_url': '',
 ...
 {'slug': 'norton-360-premium',
  ...
  'description': 'Comprehensive security suite covering up to 10 devices with Secure VPN, Password Manager, '
                 'parental controls and 75GB cloud backup.',
  'category': 'Norton 360',
  'brand': 'Norton',
  'box_variant': 'amber',
  'image_url': '',
  ...
  'variants': [{'devices': 10,
                'years': 1,
                'label': '10 Devices / 1 Year',
                'price': 54.99,
                'original_price': 59.99},
               {'devices': 10,
                'years': 2,
                'label': '10 Devices / 2 Years',
                'price': 109.99,
 ...
 {'slug': 'norton-360-with-lifelock-select',
  ...
  'description': 'Combines Norton 360 device security with LifeLock identity theft protection, credit '
                 'monitoring and stolen-funds reimbursement.',
  'category': 'LifeLock',
  'brand': 'Norton',
  'box_variant': 'black',
  'image_url': '',
  'badge': 'Popular',
  'features': ['Everything in Norton 360 Deluxe',
 ...
 {'slug': 'norton-360-for-gamers',
  ...
  'description': 'Game-optimized security with Game Optimizer, notification blocker and Secure VPN — '
                 "protection that won't interrupt your gameplay.",
  'category': 'Gaming',
  'brand': 'Norton',
  'box_variant': 'purple',
  'image_url': '',
 ...
 {'slug': 'webroot-antivirus',
  ...
  'description': 'Cloud-based antivirus that scans in seconds and uses minimal system resources. Protects '
                 'against viruses, malware, phishing and ransomware.',
  'category': 'AntiVirus',
  'brand': 'Webroot',
  'box_variant': 'green',
  'image_url': '',
  'features': ['Cloud-based scanning',
 ...
 {'slug': 'webroot-internet-security-plus',
  ...
  'description': 'Complete internet security with antivirus, anti-phishing, password manager and mobile '
                 'protection for PCs, Macs and smartphones.',
  'category': 'Internet Security',
  'brand': 'Webroot',
  'box_variant': 'green',
  'image_url': '',
  'features': ['All AntiVirus features',
 ...
 {'slug': 'webroot-internet-security-complete',
  ...
  'description': "Webroot's most complete suite — antivirus, password manager, 25GB secure cloud backup, and "
                 'system optimizer for up to 5 devices.',
  'category': 'Internet Security',
  'brand': 'Webroot',
  'box_variant': 'green',
  'image_url': '',
  'badge': 'Best Value',
  'features': ['All Internet Security Plus features',
               '25GB Cloud Backup',
               'System optimizer',
               'File & browsing privacy',
               '5 devices'],
  'variants': [{'devices': 5,
                'years': 1,
                'label': '5 Devices / 1 Year',
 ...
 {'slug': 'webroot-premium',
  ...
  'description': 'Top-tier Webroot protection with antivirus, unlimited VPN, password manager, dark web '
                 'monitoring and identity protection.',
  'category': 'Premium',
  'brand': 'Webroot',
  'box_variant': 'green',
  'image_url': '',
  'features': ['All Complete features',
               'Unlimited VPN',
               'Dark web monitoring',
               'Identity protection',
               'Priority service'],
 ...
 {'slug': 'webroot-mobile-security',
  ...
  'description': 'Protect your smartphone and tablet from malicious apps, phishing links and unsafe websites '
                 "with Webroot's mobile security.",
  'category': 'Mobile',
  'brand': 'Webroot',
  'box_variant': 'green',
  'image_url': '',
  'features': ['Malicious app blocking',
               'Web protection',
               'Anti-phishing',
               'Secure browsing',
               'Lightweight app'],
 ...
 {'slug': 'webroot-wifi-security-vpn',
  ...
  'description': "Webroot's VPN keeps your connection private on public Wi-Fi with bank-grade encryption and "
                 'a no-log policy.',
  'category': 'Privacy',
  'brand': 'Webroot',
  'box_variant': 'green',
 ...
 {'slug': 'mcafee-antivirus',
  ...
  'description': 'Award-winning antivirus that protects your PC from viruses, malware, ransomware and online '
                 'threats with real-time scanning.',
  'category': 'AntiVirus',
  'brand': 'McAfee',
  'box_variant': 'red',
  'image_url': '',
  'features': ['Real-time antivirus',
 ...
 {'slug': 'mcafee-plus-essential',
  ...
  'description': 'All-in-one protection with antivirus, Secure VPN, identity monitoring and password manager '
                 'for up to 5 devices.',
  'category': 'McAfee+',
  'brand': 'McAfee',
  'box_variant': 'red',
  'image_url': '',
  'features': ['Antivirus for 5 devices',
               'Secure VPN',
               'Identity monitoring',
               'Password Manager',
               'Web protection'],
 ...
 {'slug': 'mcafee-total-protection',
  ...
  'description': 'Comprehensive protection for the whole family — antivirus, VPN, identity monitoring, '
  ...
  'image_url': '',
  'badge': 'Best Seller',
  'features': ['Antivirus for 10 devices',
               'Secure VPN',
               'Identity monitoring',
               'Password Manager',
               'Parental controls',
 ...
 {'slug': 'mcafee-plus-premium',
  ...
  'description': 'Protect unlimited devices with antivirus, unlimited VPN, comprehensive identity '
                 'monitoring, and credit & transaction alerts.',
  'category': 'McAfee+',
  'brand': 'McAfee',
  'box_variant': 'red',
  'image_url': '',
 ...
 {'slug': 'mcafee-plus-advanced',
  ...
  'description': "McAfee's advanced tier — unlimited devices, full identity theft protection, credit lock, "
                 'and $1M identity theft coverage.',
  'category': 'McAfee+',
  'brand': 'McAfee',
  'box_variant': 'red',
  'image_url': '',
 ...
 {'slug': 'mcafee-livesafe',
  ...
  'description': 'McAfee LiveSafe protects all your PCs, Macs, smartphones and tablets with antivirus, VPN, '
