...
export default function About() {
  return (
    <PolicyLayout
      ...
      subtitle="An independent digital software reseller helping customers protect their devices with genuine Norton license keys — delivered fast, priced fairly, backed by real human support."
    ...
    >
      ...
      <Section id="values" title="Our values">
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-5">
            ...
            <p className="mt-1 text-sm text-neutral-700">Every key we sell is genuine and sourced from authorized digital channels — never grey-market or stolen.</p>
          </div>
          <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-5">
            <Users size={22} weight="duotone" className="text-neutral-900" />
            <div className="mt-3 font-display font-semibold">Real support</div>
            <p className="mt-1 text-sm text-neutral-700">A real human answers every support request. We reply within 12 hours and stay with you until your key is activated.</p>
          </div>
          <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-5">
      ...
      <Section id="how-we-work" title="How we work">
        <p>We are a lean company. Every dollar we don't spend on advertising or overhead is a dollar we can pass back to customers as lower prices. Our operational focus is on three things: sourcing genuine license inventory, keeping the buying experience simple, and answering support requests within hours (not days).</p>
      ...
      <Section id="why-us" title="Why choose BuyInstantKeys">
        <ul className="list-disc pl-6">
          ...
          <li>Genuine license keys sourced from authorized digital channels</li>
          ...
          <li>Responsive human support (info@buyinstantkeys.com)</li>
      ...
      <Section id="contact" title="Contact us">
        ...
        <p>For product questions, order support, activation help, refund requests, media & press, or legal notices, please email us at the address above. We aim to respond to every message within 12 hours.</p>
      </Section>
    </PolicyLayout>
  );
}
